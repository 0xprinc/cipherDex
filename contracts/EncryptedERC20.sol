...
contract EncryptedERC20 is Reencrypt, Ownable2Step {
    ...
    function getbal(address account) public view returns (euint32) {
    ...
    function bytestransfer(address to, bytes calldata encryptedAmount) public virtual returns (bool) {
